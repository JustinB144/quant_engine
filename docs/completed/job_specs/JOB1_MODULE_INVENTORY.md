...
**Output**: `MODULE_INVENTORY.yaml` saved to `docs/audit/data/`
...
Save the completed inventory to: `docs/audit/data/MODULE_INVENTORY.yaml`

Create the `docs/audit/data/` directory if it doesn't exist.
